...
<?php foreach($obtenerMarcas['marca'] as $listaM):?>
	<tr>
		
			<td><?php echo $listaM['id_marca']?></td>
			<td><?php echo $listaM['nombre_marca']?></td>
			<td><?php echo $listaM['activo']?></td>
			<td><a href="index.php?url=verMarca&id_marca=<?php echo $listaM['id_marca'] ?>"><img src="images/detalle.png"/></a></td>
			<td><a href="index.php?url=verMarMod&id_marca=<?php echo $listaM['id_marca'] ?>"><img src="images/editar.png"/></a></td>
			<td><a href="index.php?url=elimMarca&id_marca=<?php echo $listaM['id_marca'] ?>"  onclick='javascript:return confirmar();'><img src="images/eliminar.png"/></a></td>
			</td>
	</tr>
		<?php endforeach; ?>
</table>
...
<center>
    	...
    	<form action="#" method="POST" name="frmdoM" id="frmdoM" target="_self">            
          ...
          <!--<label>Nombre:</label>-->
          <input name="nombreM" type="text" class="form-control" required pattern="|^[a-zA-Z ñÑáéíóúÁÉÍÓÚüÜ]*$|" placeholder="Ingresa nombre marca"/><br>
