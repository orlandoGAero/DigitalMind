										...
										<ul>
											<li>
												...
												<ul>
													...
													<li><label>Nombre</label><input type="text" name="nameContact" autofocus="autofocus" autocomplete="off" required="required" maxlength="50" value="<?php echo $obtenerDatosContacto['nombreCon'] ?>" /><span style="color: red;"><b>&nbsp;*</b></span></li>
													<li><label>Apellido Paterno</label><input type="text" name="ApPContact" autocomplete="off" required="required" maxlength="50" value="<?php echo $obtenerDatosContacto['ap_paterno'] ?>" /><span style="color: red;"><b>&nbsp;*</b></span></li>
													<li><label>Apellido Materno</label><input type="text" name="ApMContact" autocomplete="off" required="required" maxlength="50" value="<?php echo $obtenerDatosContacto['ap_materno'] ?>" /><span style="color: red;"><b>&nbsp;*</b></span></li>
													<li><label>Área</label><input type="text" name="nameArea" autocomplete="off" required="required" maxlength="50" value="<?php echo $obtenerDatosContacto['nombre_area'] ?>" /><span style="color: red;"><b>*</b></span></li>
													<li><label>Teléfono Móvil</label><input type="text" id="tel" class="keysNumbers" name="telMovil" autocomplete="off" required="required" maxlength="10" value="<?php echo $obtenerDatosContacto['movil'] ?>" /><span style="color: red;"><b>&nbsp;*</b></span></li>
													<li><label>Teléfono Oficina</label><input type="text" id="tel" class="keysNumbers" name="telOficina" autocomplete="off" required="required" maxlength="10" value="<?php echo $obtenerDatosContacto['tel_oficina'] ?>" /><span style="color: red;"><b>&nbsp;*</b></span></li>
													<li><label>Teléfono Emergencia</label><input type="text" id="tel" class="keysNumbers" name="telEmergencia" autocomplete="off" required="required" maxlength="10" value="<?php echo $obtenerDatosContacto['tel_emergencia'] ?>" /><span style="color: red;"><b>&nbsp;*</b></span></li>
													<li><label>Correo Personal</label><input type="email" name="emailPersonal" autocomplete="off" required="required" maxlength="50" placeholder="nombre@ejemplo.com" value="<?php echo $obtenerDatosContacto['correo_p'] ?>" /><span style="color: red;"><b>&nbsp;*</b></span></li>
													<li><label>Correo Institucional</label><input type="email" name="emailInstitucional" autocomplete="off" maxlength="50" placeholder="nombre@ejemplo.com" value="<?php echo $obtenerDatosContacto['correo_instu'] ?>" />&nbsp;&nbsp;&nbsp;</li>
													<li><label>Facebook</label><input type="text" name="redSocialF"  autocomplete="off" maxlength="20" value="<?php echo $obtenerDatosContacto['facebook'] ?>" />&nbsp;&nbsp;&nbsp;</li>
										...
										<ul>
											<li>
												...
												<ul>
													...
													<li><label>Código Postal</label><input type="text" class="keysNumbers" name="postcode" autocomplete="off" required="required"  maxlength="5"  value="<?php echo $obtenerDatosContacto['codigoP'] ?>" onKeyUp="cpview(this.form)" /><span style="color: red;"><b>&nbsp;*</b></span></li>
																	...
																	<tr>
																		...
																		<td>
																			<select id="loc" name="idcp-locality" >
																				...
																				<?php endif; ?>
																				<?php foreach ($obtenerDatosContacto['codigoP'] as $locality) : ?>
