...
<?php endif; ?>
	...
	<div class="col-lg-14">
        <div class="panel panel-default">
			<h1><a href="index.php?url=listContact" title="regresar" onclick="return confirm('Desea salir antes de guardar?');"><img src="images/salir.png" width="30px" height="30px" /></a>Nuevo Contacto</h1>
							...
							<ul>
								<form action="index.php?url=insertContact" method="POST" id="formContact" target="_self" >
									<li><a href="#">Datos Contacto</a>
										<ul>
											<li>
												<table  class="nuevo-pro" border="1" width="100%" >
													<tr> <!-- IdContacto --> <td><input type="hidden" name="idContact" value="<?php echo $parametrosContactos['idCont']  ?>" readonly /> </td> <td></td> </tr>
													<tr> <th> Nombre </th> <td> <input type="text" name="nameContact" autofocus="autofocus" autocomplete="off" required="required" maxlength="50" value="<?php echo $parametrosContactos['nombre'] ?>" /> </td> <td> * </td></tr>
													<tr> <th> Apellido Paterno </th> <td> <input type="text" name="ApPContact" autocomplete="off" required="required" maxlength="50" value="<?php echo $parametrosContactos['app'] ?>" /> </td> <td> * </td></tr>
													<tr> <th> Apellido Materno </th> <td> <input type="text" name="ApMContact" autocomplete="off" required="required" maxlength="50" value="<?php echo $parametrosContactos['apm'] ?>" /> </td> <td> * </td></tr>
													<tr> <th> Área </th> <td> <input type="text" name="nameArea" autocomplete="off" required="required" maxlength="50" value="<?php echo $parametrosContactos['area'] ?>" /> </td> <td> * </td> </tr>
													<tr> <th> Teléfono Móvil </th> <td> <input type="text" id="tel" class="keysNumbers" name="telMovil" autocomplete="off" required="required" maxlength="10" value="<?php echo $parametrosContactos['movil'] ?>" /> </td> <td> * </td></tr>
													<tr> <th> Teléfono Oficina </th> <td> <input type="text" id="tel" class="keysNumbers" name="telOficina" autocomplete="off" required="required" maxlength="10" value="<?php echo $parametrosContactos['tel_ofi'] ?>" /> </td> <td> * </td></tr>
													<tr> <th> Teléfono Emergencia </th> <td> <input type="text" id="tel" class="keysNumbers" name="telEmergencia" autocomplete="off" required="required" maxlength="10" value="<?php echo $parametrosContactos['tel_emer'] ?>" /> </td> <td> * </td></tr>
													<tr> <th> Correo Personal </th> <td> <input type="email" name="emailPersonal" autocomplete="off" required="required" maxlength="50" placeholder="nombre@ejemplo.com" value="<?php echo $parametrosContactos['correoPers'] ?>" /> </td> <td> * </td></tr>
											...
											<li>
												...
												<table class="nuevo-pro" border="1" width="100%" >
													...
													<?php if($parametrosContactos['cp'] == "") :?>
														<tr><td colspan="3"><div id="resultado"> </div></td></tr>
													<?php else :?>
														<tr><td colspan="3">
															<div id="resultado"> 
													...
													<tr><th>Calle</th><td><input type="text" name="street" autocomplete="off" required="required" maxlength="50" value="<?php echo $parametrosContactos['calleD'] ?>" /> </td> <td> * </td></tr>
													<tr><th>No. Ext</th><td><input type="text" class="keysNumbers" name="numExt" autocomplete="off" required="required" maxlength="5" value="<?php echo $parametrosContactos['numExterior'] ?>" /> </td> <td> * </td></tr>
													...
													<tr><th>Colonia</th><td><input type="text" name="colonia" autocomplete="off" required="required" maxlength="50" value="<?php echo $parametrosContactos['coloniaD'] ?>" /> </td> <td> * </td></tr>
