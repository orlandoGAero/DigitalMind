										...
										<ul>
											<li>
												<table  class="nuevo-pro" >
													<tr> <!-- IdContacto --> <td> <input type="text" name="idContact" value="<?php echo $parametrosContactos['idCont']  ?>" readonly /> </td>  </tr>
													...
													<tr> <th> Teléfono Móvil </th> <td> <input type="number" name="telMovil" autocomplete="off" required="required" maxlength="10" value="<?php echo $parametrosContactos['movil'] ?>" /> * </td>  </tr>
													<tr> <th> Teléfono Oficina </th> <td> <input type="number" name="telOficina" autocomplete="off" required="required" maxlength="10" value="<?php echo $parametrosContactos['tel_ofi'] ?>" /> * </td>  </tr>
													<tr> <th> Teléfono Emergencia </th> <td> <input type="number" name="telEmergencia" autocomplete="off" required="required" maxlength="10" value="<?php echo $parametrosContactos['tel_emer'] ?>" /> * </td>  </tr>
											...
											<li>
												<table class="nuevo-pro" >
													<tr class="direccion">
														...
														<tr>
															<th>Código Postal</th>
															<td><input type="number" name="postcode" autocomplete="off" required="required" min="1000" max="99999" maxlength="5"  onKeyUp="cpview(this.form)"  /></td>
														...
														<tr><th>No. Ext</th><td><input type="number" name="numExt" autocomplete="off" required="required" maxlength="5" value="<?php echo $parametrosContactos['numExterior'] ?>" /> * </td></tr>
														<tr><th>No. Int</th><td><input type="number"  name="numInt" autocomplete="off" maxlength="5" value="<?php echo $parametrosContactos['numInterior'] ?>" /></td></tr>
